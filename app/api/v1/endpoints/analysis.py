...
MAX_FILE_SIZE = 5120 * 1024  # 5MB em bytes
...
def save_upload_file(upload_file: UploadFile) -> tuple[str, int, str]:
    ...
    relative_location = f"media/{filename}"  # 👈 igual ao Laravel
    ...
    return relative_location, file_size, extension  # 👈 location = "media/uuid.jpg"
